...
class Dispatcher:
    ...
    def __init__(
        ...
        author="",
        description="",
        parsers: list[Dispatcher | Type[Parser]] = None,
        greedy=False,
        default: Dispatcher | Type[Parser] = UnidentifiedFile,
        ...
        :param dict config: Custom configuration for the parser group.
        """
        self.name = name
        self.source = source
    ...
    def _parse(self, file_object, parser, report, *run_args):
        ...
        try:
            ...
            logger.exception(f"{parser.name} dispatch parser failed")
            ...
            try:
                ...
                if identified or (not parent and self._output_unidentified):
                    if file_object.output_file:
                        ...
                        # reported correctly.
                        with report.parsing_file(file_object.parent):
