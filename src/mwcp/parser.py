...
class Parser(metaclass=ParserMeta):
    ...
    def config(self) -> dict:
        """Configuration set by the configuration yaml file."""
    ...
    # TODO: See if we can provide a way for this to be allowed to be either a instance function or class method.
    @classmethod
